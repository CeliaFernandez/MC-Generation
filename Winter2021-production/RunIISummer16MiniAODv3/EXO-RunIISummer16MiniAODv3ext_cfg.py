...
# with command line options: --python_filename EXO-RunIISummer16MiniAODv3_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:EXO-RunIISummer16MiniAODv3-14050.root --conditions 94X_mcRun2_asymptotic_v3 --step PAT --filein file:EXO-RunIISummer16DR80Premix-2.root --era Run2_2016,run2_miniAOD_80XLegacy --runUnscheduled --no_exec --mc -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:EXO-RunIISummer16DR80Premix-2.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIISummer16MiniAODv3ext.root'),
