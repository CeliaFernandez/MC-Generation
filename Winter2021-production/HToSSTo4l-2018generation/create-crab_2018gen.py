...
parser.add_option('-n', '--nEvents', action='store', type=int, dest='nEvents', default=50000, help='Events per model')
parser.add_option('-s', '--nSplit', action='store', type=int, dest='nSplit', default=50, help='Events per job')
...
config.Data.outputPrimaryDataset = 'ggH_HToSSTo4l_MH-MASSHIGGS_MS-MASSX_ctauS-CTAU_TuneCP5_13TeV-powheg-pythia8'

config.Data.outputDatasetTag = 'RunIIFall18wmGS'
